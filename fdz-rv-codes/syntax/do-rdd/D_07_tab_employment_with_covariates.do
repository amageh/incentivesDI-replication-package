...
* Purpose: RDD estimates employment with covariates
********************************************************************************
...
foreach g in aall female male {
	...
	********************************************************************************
	...
	matrix list MAT
	matsave MAT, replace p($D_TEMP_LABOR/with_controls/) dropall
	use $D_TEMP_LABOR/with_controls/MAT.dta, replace
	...
	* rename vars
	...
	drop _rowname
	gen subsample = "`g'"
	save $D_TEMP_LABOR/with_controls/MAT_`g'.dta, replace
		
}

use $D_TEMP_LABOR/with_controls/MAT_aall.dta, clear 
